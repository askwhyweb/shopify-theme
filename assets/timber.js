        ...
        jQuery.each(cart, function(key, value) {
            if (key === 'items') {
                ...
                if (value.length) {
                    ...
                    $html += '<img src="//cdn.shopify.com/s/files/1/0065/6356/1533/t/92/assets/checkout-button-icon.png?1411402" alt="" class="addIcon" />';
                    ...
                    $html +=  '</li><img alt="Checkout Secure" src="//cdn.shopify.com/s/files/1/0065/6356/1533/t/92/assets/checkout_icon.png?1411402" class="no-border checkout-img ratina-img">';
...
/// Live search
var preLoadLoadGif = $('<img src="//cdn.shopify.com/s/files/1/0065/6356/1533/t/92/assets/ajax-load.gif?1411402" />');
...
$(document).on('keyup change', '.search_panel input[type="text"]', function(){
    ...
    if($(this).val().length > 2 && $(this).val() != $(this).data('oldval')) {
        ...
        //Show loading
        $resultsBox.html('<div class="load"><img src="//cdn.shopify.com/s/files/1/0065/6356/1533/t/92/assets/ajax-load.gif?1411402"></div>');
