;(function (Wishlist, $) {
  ...
  var animateWishlist = function (self) {
   ...
   $(".action--wishlist span").html('<img class="btn--main" src="//cdn.shopify.com/s/files/1/0065/6356/1533/t/20/assets/icn-wishlist-added.svg?10401219496324850891" alt="">  Added to Wishlist');
    }
    else{
